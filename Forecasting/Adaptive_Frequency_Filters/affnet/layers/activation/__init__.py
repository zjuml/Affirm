...
def build_activation_layer(
    ...
    **kwargs
    ...
    act_layer = None
    print("Activation functions supported: {}".format(SUPPORTED_ACT_FNS))
    print("ACT_FN_REGISTRY: {}".format(ACT_FN_REGISTRY))
    print("Activation functions registered: {}".format(ACT_FN_REGISTRY.keys()))
